...
.. panels::
    ...
    New to *RecoEdge*? Check out the getting started guide. It will walk you
    through the moto of *RecoEdge* and the steps to get started 
    ...
    The tutorials provides in-depth information on the
    key concepts of RecoEdge with useful background information and explanation.
    ...
    the RecoEdge API. The reference describes how the methods work and which
    parameters can be used. It assumes that you have an understanding of the key
    concepts.

    +++

    .. link-button:: recoedge-api
            :type: ref
            :text: To the developer docs
            :classes: btn-block btn-secondary stretched-link
    ...
    .. link-button:: recoedge-development
            :type: ref
